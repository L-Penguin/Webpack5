...
class TestPlugin {
    ...
    apply(compiler) {
        ...
        compiler.hooks.emit.tap("TestPlugin", (compilation) => {
            ...
            console.log("TesPlugin emit 111");
        });

        compiler.hooks.emit.tapAsync("TestPlugin", (compilation, callback) => {
            setTimeout(() => {
                console.log("TesPlugin emit 222");
                callback();
            }, 1000);
        });
        ...
        compiler.hooks.emit.tapPromise("TestPlugin", (compilation) => {
            return new Promise((resolve) => {
                setTimeout(() => {
                    console.log("TesPlugin emit 333");
                    resolve();
                }, 2000);
            })
        });
        ...
        compiler.hooks.make.tapAsync("TestPlugin", (compilation, callback) => {
            ...
            setTimeout(() => {
                console.log("TestPlugion make 111");
                callback();
            }, 3000);
        });
        ...
        compiler.hooks.make.tapAsync("TestPlugin", (compilation, callback) => {
            setTimeout(() => {
                console.log("TestPlugion make 222");
                callback();
            }, 1000);
        });
        ...
        compiler.hooks.make.tapAsync("TestPlugin", (compilation, callback) => {
            setTimeout(() => {
                console.log("TestPlugion make 333");
                callback();
            }, 2000);
        });
    }
